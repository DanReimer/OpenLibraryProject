...
class CoversControllerTest < ActionDispatch::IntegrationTest
  ...
  test "should create cover" do
    assert_difference('Cover.count') do
      post covers_url, params: { cover: { book_id: @cover.book_id, largeLink: @cover.largeLink, mediumLink: @cover.mediumLink, smallLink: @cover.smallLink } }
    end
  ...
  test "should update cover" do
    patch cover_url(@cover), params: { cover: { book_id: @cover.book_id, largeLink: @cover.largeLink, mediumLink: @cover.mediumLink, smallLink: @cover.smallLink } }
