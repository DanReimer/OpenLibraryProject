...
class IdentifiersControllerTest < ActionDispatch::IntegrationTest
  ...
  test "should create identifier" do
    assert_difference('Identifier.count') do
      post identifiers_url, params: { identifier: { book_id: @identifier.book_id, number: @identifier.number, type: @identifier.type } }
    end
  ...
  test "should update identifier" do
    patch identifier_url(@identifier), params: { identifier: { book_id: @identifier.book_id, number: @identifier.number, type: @identifier.type } }
